...
- **背景**(`.sea`): ダークは深海(光の帯 2 層、昇る泡、まばらなマリンスノー、下ほど深い青み)、ライトは水面(上部の光のゆらめき 2 層、柔らかい波紋 3 つ、息をする光の点、上ほど空の水色)。出ない側は色を透明にして隠す。CSS のみで transform だけを動かし、reduced-motion では静止。
